package com.notification.service.infrastructure.config.swagger;
    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        ...
                        .version("1.0.0")
                        .description(
                                "Esta API disponibiliza o serviço de notificação do sistema Abrigo Dog Feliz, " +
                                        "permitindo o gerenciamento de notificações no site."
                        )
                        .contact(new Contact()
